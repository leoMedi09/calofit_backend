...
class User(Base):
    ...
    clients_as_coach = relationship("Client", foreign_keys="Client.assigned_coach_id", back_populates="coach")
    clients_as_nutri = relationship("Client", foreign_keys="Client.assigned_nutri_id", back_populates="nutritionist")
