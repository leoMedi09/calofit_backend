...
class IAService:
    ...
    async def clasificar_modo_asistente(self, mensaje: str, historial: list = None) -> Optional[str]:
        ...
        prompt = (
            ...
            "recomendar_nutricion — el usuario PIDE ideas de qué comer SIN nombrar un alimento "
            "específico (futuro/duda abierta)\n"
            "  Señal clave: preguntas o expresión de hambre/duda, sin nombrar ningún alimento concreto\n"
            "  ✓ '¿qué ceno?'  ✓ 'tengo hambre'  ✓ 'dame opciones para almorzar'  ✓ 'qué me recomiendas'\n"
            "  (si el usuario SÍ nombra un alimento específico y pregunta si es bueno comerlo, "
            "ver R8 — eso es 'otro', no esto)\n\n"
            ...
            "R9. CITA DE TERCERO ≠ ACCIÓN PROPIA: 'ejercicio + series/peso' SIN ningún marcador "
            "de cita/tercero (ej. 'sentadillas 4x12 con 80kg') SIGUE SIENDO registrar_ejercicio — "
            "es la forma telegráfica normal de reportar un entrenamiento propio (el 'hice' está "
            "implícito), NO la trates como insuficiente. Solo clasifica como 'otro' cuando hay una "
            "marca EXPLÍCITA de que la fuente es otra persona o un medio externo, no el usuario "
            "mismo (ej. 'leí que...', 'vi un video de...', 'mi entrenador me dijo que haga...', "
            "'dicen que...', 'es lo que hacen los profesionales').\n"
            "  ✓ 'sentadillas 4x12 con 80kg' (sin marca de cita) → registrar_ejercicio\n"
